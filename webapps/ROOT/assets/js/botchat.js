                ...
                return r.__extends(e, t), e.prototype.render = function() {
                    ...
                    if (r == 'me') {
                        ...
                        return o.createElement("div", {
                            ...
                            o.createElement("img", {
                                src: "assets/image/chatbotStyle/ico_profi_80_old.png", className: "wc-message-callout"
                        }
                        //o.createElement("svg", {
...
function appendLoadingDiv() {
    ...
    if ($('#loading').length == 0) {
        $('.wc-message-group-content').append('<div id="loading" class="wc-message-wrapper list">'
            ...
            //+ '</svg>'
            + '<img src="assets/image/chatbotStyle/ico_profi_80_old.png" class="wc-message-callout">'
            + '<div>'
